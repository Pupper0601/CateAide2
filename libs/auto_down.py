...
def mouse_move_y(gun_data: dict):
    ...
    for index, value in enumerate(move_coefficient):
        ...
        while round(time.perf_counter(), 3) * 1000 - start_time < gun_data["weapon_intervals"]:
            ...
            if not is_mouse_button_down(VK_LBUTTON) or elapsed > gun_data["weapon_intervals"] - 10:
                if move_sum > 0:
                    mouse_move(0, _speed)
