...
from qfluentwidgets import (BodyLabel, CheckBox, ImageLabel, InfoBar, InfoBarPosition, LineEdit, MSFluentTitleBar,
                            PasswordLineEdit, PrimaryPushButton, isDarkTheme, setThemeColor)
...
class RegisterWindow(Window):
    ...
    def __initWidgets(self):
        ...
        self.setWindowTitle('CateAide2')
        self.setWindowIcon(QIcon(":/app/images/login_bg.png"))
        self.resize(600, 400)
